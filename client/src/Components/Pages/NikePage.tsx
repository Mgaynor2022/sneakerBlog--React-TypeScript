...
const NikePage: React.FC = () => {
  ...
  const { allSneakers, backButton, user } =
    useContext<UserContextType>(UserContext);

  const { likePublicSneakers, dislikePublicSneakers, getPublicSneakers } =
  ...
  const filteredNike = allSneakers.filter(
    (sneaker) => sneaker.details.brand === click
  );
