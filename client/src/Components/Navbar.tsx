...
const Navbar = (props: { logout: any }) => {
  ...
  return (
    <>
      <nav
        id="bigNavbar"
        className="bg-black px-8 py-8 flex justify-between items-center"
      >
        ...
        <ul className="flex items-center uppercase text-sm ml-8">
          ...
          <li className="ml-6 ">
            <button
              onClick={logout}
              className="px-5 py-2 bg-red-500 text-white font-semibold hover:bg-gray-700"
            >
              Logout
            </button>
          </li>
      ...
      <div id="mobile">
        <nav
          id="mobileNavbar"
          className="px-2 py-5  bg-black items-center w-screen fixed z-20 mb-20"
        >
          ...
          <div
            className={
              toggleNavbar
                ? "flex justify-center tracking-wide w-full z-50 bg-black"
                : "hidden"
            }
            id="navbar-hamburger"
          >
